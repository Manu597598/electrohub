  ...
  return (
    <div className='flex justify-center items-center min-h-screen bg-red-100 text-black'>
      ...
      <CardFooter className="flex-col gap-2">
        ...
        <Button onClick={submitHandler} type="submit" className="w-full cursor-pointer bg-red-900 hover:bg-red-800">
          {loading? <><Loader2 className='h-4 w-4 animate-spin mr-2'/>Please wait</>:'Signup'}
        </Button>
        <p>Already have an account? <Link to={'/login'} className='hover:underline cursor-pointer text-red-600 '>Login</Link></p>
      </CardFooter>
    </Card>
    </div>
  );
